...
(5) Open in the browser: `http://localhost/make-a-ten/make-a-ten_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/make-a-ten/build/adapted-from-phet/make-a-ten_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
