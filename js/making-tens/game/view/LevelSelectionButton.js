...
/**
 * Button for selecting a game level. The user of MakingTens game
 * can play as many level as he wants and there is no such thing as perfect score.
 * The Vegas LevelSelectionButton is copied over to MakingTens, because of the need to display
